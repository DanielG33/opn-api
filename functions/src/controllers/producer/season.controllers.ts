...
export const listSeasons = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, error: { message: 'Failed to fetch seasons' } });
  }
};
...
export const updateSeasonController = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(422).json({ success: false, error: { message: 'Failed to update season' } });
  }
};
...
export const deleteSeasonController = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, error: { message: 'Failed to delete season' } });
  }
};
