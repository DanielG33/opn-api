...
export const listProducerEpisodes = async (req: Request, res: Response) => {
    ...
    try {
        ...
        return res.status(500).json({ success: false, error: { message: 'Failed to load episodes' } });
    }
};
...
export const updateProducerEpisode = async (req: Request, res: Response) => {
    ...
    try {
        ...
        res.status(422).json({ success: false, error: { message: 'Failed to update episode' } });
    }
};
...
export const deleteProducerEpisode = async (req: Request, res: Response) => {
    ...
    try {
        ...
        res.status(500).json({ success: false, error: { message: 'Failed to delete episode' } });
    }
};
